...
def explicate_control(prog: Program) -> cfun.CProgram:
    ...
    def ec_function(name: str, params: List[Tuple[str, type]], body_stmts: List[Stmt], return_type: type):
        ...
        # TODO: Follow question 17 instructs
    ...
    # Now: return a list of cfucntion definitions
...
def select_instructions(prog: cfun.CProgram) -> X86ProgramDefs:
    ...
    def si_def(d: cfun.CFunctionDef) -> X86FunctionDef:
        # TODO: full in using excercise #2
        blocks??
...
def _allocate_registers(name: str, program: x86.X86Program) -> x86.X86Program:
    ...
    # interference graph
    # --------------------------------------------------
    def bi_instr(e: x86.Instr, live_after: Set[x86.Arg], graph: InterferenceGraph):
        match e:
    ...
    def bi_block(instrs: List[x86.Instr], live_afters: List[Set[x86.Arg]], graph: InterferenceGraph):
